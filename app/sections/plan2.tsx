export default function PlanPart2() {
  const weeks = [
    {
      week: "WEEK 5",
      title: "Meeting Handoff\n& Support",
      description: "Ensure scheduled\nmeetings run smoothly\nwhile supporting the BD\nor AE team",
      color: "bg-[#451e06]",
    },
    {
      week: "WEEK 6",
      title: "Consistent\nOutreach Execution",
      description: "Maintain 25-30 personalized\noutreaches per day to\nincrease engagement and\nmeeting opportunities",
      color: "bg-[#873809]",
    },
    {
      week: "WEEK 7",
      title: "Messaging\nOptimization",
      description: "Continuously refine\noutreach messaging to\nmaintain strong reply rates\nand meeting conversions",
      color: "bg-[#d35a24]",
    },
    {
      week: "WEEK 8",
      title: "Pipeline Growth &\nDeal Support",
      description: "Generate new opportunities\nwhile supporting the sales\nteam in negotiations through\nto deal closure",
      color: "bg-[#c2854b]",
    },
  ];

  return (
    <section id="plan-month-2" className="w-full py-24 rounded-xl max-w-[1400px] mx-auto my-16 px-6 md:px-12 lg:px-16 bg-primary-light">
      
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start mb-16">
        <div>
            <h2 className="text-4xl md:text-5xl font-extrabold text-brown mb-4">
            My SDR 60-Day Plan:<br />Month 2 - Scaling & Optimization
          </h2>
        </div>
      </div>
